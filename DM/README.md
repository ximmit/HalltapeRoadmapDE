...
***
**Таблица фактов** — главая таблица, в которой пишутся события, например текущие заказы или действия пользователей на сайте. Т.е. некие события, которые скорее всего имеют уникальный характер.
