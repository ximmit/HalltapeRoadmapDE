...
> У меня нет для вас другого решения, как пройти фильтры рекрутеров по годам опыта, кроме как накрутка. Стажировки для НЕ СТУДЕНТОВ почти отсутствуют. Как попасть без опыта вчерашнему выпускнику универа, не говоря уже о 30+ летних, я не знаю. Поэтому, если не хотите сидеть в жопе без работы и без денег, делайте ТО, ЧТО ВАМ РЕКОМЕНДУЮТ ЛЮДИ, КОТОРЫЕ ЧЕРЕЗ ЭТО ПРОШЛИ.
...
Если вы закончили универ вчера или 100 лет назад, то для вас СТАЖИРОВОК не существует. Я даже не хочу это обсуждать. Если стажировка и есть, то платят на ней 50-80к рублей в месяц. При этом вам может понадобится перебраться в Москву и ходить в офис. Где и на что вы будете жить, я не знаю.

Не переживайте, вы найдете первую работу! И по деньгам это будет больше 120к на руки. Хотя у меня лично есть примеры, когда люди залетали сразу на мидла на 200к на руки. Нужны будут пруфы - пиши мне в телегу.
...
<table>
    ...
    <tr>
        <td>Работал монтажником. Написал телеграм бота, который собирал данные по расходникам с каждого объекта и складывал все в СУБД PostgreSQL. Все было развернуто в Docker на сервере и каждый вечер, неделю, месяц Airflow читал данные из базы данных и внутри pandas или pyspark строили витрины отчеты для руководства</td>
    <tr>
<table>
...
>❗️❗️ Крутить можно и больше лет. Вопрос только в том, насколько вы готовы за это брать ответственность. На 2-3 года накрученного опыта вас будут спрашивать конкретные кейсы (примеры решенных задач). Я рекомендую идти либо на джуна, либо на джун+. Через год вы станете уже мидлом и сможете мощно заявлять любые шестизначные суммы.
