...
Apache Spark — представляет собой целую экосистему **экосистема модулей**, предоставляющую мощные средства для работы с данными в различных форматах и задачах: от SQL-запросов и машинного обучения до потоковой обработки и анализа графов.
