...
Понимание Hadoop Distributed File System  - один из наиболее часто встречающихся вопросов на собеседованиях, так что разбираться в этой теме стоит каждому Дата-инженеру
